...
class Trainer1(object):
    ...
    def __init__(self, cuda, model, optimizer, criterion,
        ...
        self.best_mean_iu = 0
        self.epochs = int(math.ceil(1. * self.max_iter / len(self.train_loader)))
...
#             #     break
#             if batch_idx % 10 == 0:
#                 print("epoch{}, iter{}, loss: {}".format(epoch, batch_idx, loss.data[0]))
    ...
    def val(self, epoch):
        ...
        for iter, (data, target) in tqdm.tqdm(
            ...
            if self.cuda:
                ...
                # self.model = torch.nn.DataParallel(self.model, device_ids=num_gpu)
